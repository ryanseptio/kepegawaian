<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-tambah-pegawai" method="POST">
    ...
    <div class="input-group form-group">
      ...
      <input type="number" class="form-control" placeholder="Nomor Telepon" name="telp" aria-describedby="sizing-addon2">
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
    ...
    <div class="input-group form-group">
      ...
      <select name="departemen" class="form-control select2"  aria-describedby="sizing-addon2" style="width: 100%">
        ...
        foreach ($dataDepartemen as $departemen) {
          ?>
          <option value="<?php echo $departemen->nama_departemen; ?>">
    ...
    <div class="input-group form-group">
      ...
      <input type="number" class="form-control" placeholder="Absensi Pegawai" name="absensi" aria-describedby="sizing-addon2">
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
        <i class="glyphicon glyphicon-user"></i>
